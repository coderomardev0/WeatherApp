...
public class WeatherController {
	...
	public Weather getWeather(@PathVariable String city, @PathVariable boolean save) throws JsonMappingException, 
		JsonProcessingException {
		
		logger.debug("Getting City {}, Saving City {}", city, save);
