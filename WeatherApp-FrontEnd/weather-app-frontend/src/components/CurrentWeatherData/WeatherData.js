  ...
  return (
    <div className="w-full min-h-screen bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0">
      ...
      <form
        ...
        } h-16 bg-white/30 w-full max-w-[700px]
        rounded-full backdrop-blur-[32px] mb-10 mt-10`}
      >
        <div className="h-full relative flex items-center justify-between p-2">
          ...
          <button
            ...
            className="bg-indigo-500  hover:bg-indigo-700 focus:bg-purple-600 w-20 h-12 rounded-full flex justify-center items-center transition"
          >
      ...
      {/* card */}
      <div className="w-full max-w-[700px] bg-white/30 min-h-[584px] text-white backdrop-blur-[80px] rounded-[32px] py-12 px-3">
        {loading ? (
